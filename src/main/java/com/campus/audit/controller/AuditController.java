...
public class AuditController {
    ...
    public ResponseEntity<ApiResponse<PageResult<AuditLogVo>>> list(HttpServletRequest request) {
        return ResponseEntity.ok(ApiResponse.ok(auditService.list(request)));
    }
}
